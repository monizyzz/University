...
void computeNormal(int i, int j, std::vector<float>& normal) {
	...
	// to do: fill the normal vector with the normal for vertex at grid location (i,j)
	float v1[3] = {0.0f, 0.0f, 0.0f};
	float v2[3]= {0.0f, 0.0f, 0.0f};

	float n[3] = {0.0f, 0.0f, 0.0f};
	float l = 0.0f; // tamanho dos vetores

	v1[0] = 0.0f; // P2.x - P1.x
	v1[1] = h(i, j + 1) - h(i, j - 1); // P2.y - P1.y
	v1[2] = 2.0f; // P2.z - P1.z

	v2[0] = 2.0f; // P4.x - P3.x
	v2[1] = h(i + 1, j) - h(i - 1, j); // P4.y - P3.y
	v2[2] = 0.0f; // P4.z - P3.z
	...
	//glNormal3f(n[0] / l, n[1] / l, n[2] / l); se não usar VBO
}
