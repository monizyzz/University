...
void prepareCylinder(float altura, float raio, int lados) {
	...
	t = (float *)malloc(sizeof(float) * 4 * 2 * 3 * lados);


	int vertex = 0;
	float delta = 2.0f * _PI_ / lados;

	for (float i = 0; i < lados; ++i) {
		// topo
		// ponto central
		n[vertex*3 + 0] = 0.0f; 
		n[vertex*3 + 1] = 1.0f;
		...
		t[vertex * 2 + 0] = 0.4375f + sin(i * delta) * 0.1875;
		t[vertex * 2 + 1] = 0.1875f + cos(i * delta) * 0.1875;
		...
		t[vertex * 2 + 0] = 0.4375f + sin((i + 1) * delta) * 0.1875;
		t[vertex * 2 + 1] = 0.1875f + cos((i + 1) * delta) * 0.1875;
		...
		t[vertex * 2 + 0] = 0.8125f + sin((i + 1) * delta) * 0.1875;
		t[vertex * 2 + 1] = 0.1875f + cos((i + 1) * delta) * 0.1875;
		...
		t[vertex * 2 + 0] = 0.8125f + sin(i * delta) * 0.1875;
		t[vertex * 2 + 1] = 0.1875f + cos(i * delta) * 0.1875;
